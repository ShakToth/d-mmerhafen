...
<?php if ($view === 'room'): ?>
    ...
    <div class="top-nav">
        ...
        <div class="nav-center">
            <a href="bibliothek.php" class="nav-link" style="color: var(--accent-gold);">Die Bibliothek</a>
    ...
    <!-- Zeichnungen -->
    <a href="?cat=images" class="fullscreen-hotspot hotspot" style="top: 34.4189%; left: 27.6429%; width: 17.5%; height: 28.0062%;">
        <span class="hotspot-label">🖼️ Zeichnungen</span>
    </a>
    
    <!-- Bücher -->
    <a href="?cat=books" class="fullscreen-hotspot hotspot" style="top: 43.4719%; left: 50.0714%; width: 11.5714%; height: 17.3643%;">
        <span class="hotspot-label">📚 Bücher</span>
    </a>
    ...
    <!-- Verboten -->
    <a href="?cat=forbidden" class="fullscreen-hotspot hotspot" style="top: 24.909%; left: 69.90%; width: 21.0714%; height: 26.4516%;">
        <span class="hotspot-label" style="color: #ff5555;">⛔ Verboten</span>
    </a>
    
    <!-- Archiv -->
    <a href="?cat=archive" class="fullscreen-hotspot hotspot" style="top: 50.818%; left: 68.1429%; width: 18.4286%; height: 20.3151%;">
        <span class="hotspot-label">📦 Archiv</span>
    </a>
    ...
    <div class="container <?php echo ($view === 'forbidden' || (isset($files[0]) && $files[0]['category'] === 'forbidden')) ? 'container-forbidden' : ''; ?>">
        <header>
            <h1>
                <?php 
                    ...
                    elseif ($view === 'admin') echo '📋 Verwaltung';
            ...
            <a href="<?php echo ($view === 'room') ? 'index.php' : 'bibliothek.php'; ?>" class="back-btn">⌂ Raum verlassen</a>
        </header>
        ...
        <div class="controls">
            ...
            <form method="get" style="flex:1; text-align:right;">
                <input type="text" name="q" placeholder="🔍 Alle Bereiche durchsuchen..." value="<?php echo htmlspecialchars($query); ?>" style="width: 70%;">
                    ...
                    <div class="card-wrapper">
                        ...
                        <?php if (isAdmin()): ?>
                            <form method="post" style="margin: 0;" onsubmit="return confirm('Endgültig vernichten?');">
                                ...
                                <button type="submit" class="delete-btn" title="Verbrennen">🔥</button>
                            </form>
                        <?php endif; ?>
                    </div>
                <?php endforeach; ?>
